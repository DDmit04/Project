...
<div class="sidebar-fixed position-fixed grey lighten-3 shadow">
	<div class="list-group list-group-flush">
		...
		<a class="list-group-item" href="/messages"><i class="far fa-envelope mr-2"></i>Messages</a>
		<a class="list-group-item" href="/posts/all"><i class="fas fa-newspaper mr-2"></i>Posts</a>
